...
export const rheiformes: Bird[] = [
  {
    ...
    description: {
      general:
        'El ñandú es el ave más grande de Sudamérica. A nivel global se encuentra Casi amenazada, pero en Uruguay su estado de conservación es "Preocupación menor".',
      curiosities:
        'El macho se reproduce con varias hembras, las cuales depositan todos los huevos en un mismo nido. El macho posteriormente se encarga de la incubación y la cría. Las crías de ñandú tienen el nombre de "charabones".',
    },
    variations: [
      {
        id: "macho",
