...
export const passeriformes: Bird[] = [
  ...
  },
  {
    ...
    description: {
      general:
        "Un ave muy común y altamente vocal. Muy territorial; cuando se enfrenta a alguna amenaza, expone una cresta color amarillo. Se enfrenta a otras aves y animales para defender su nido, incluso aves de mucho mayor tamaño y parásitos de cría como el Tordo Común. Su alimentación es omnívora y variada: se le puede ver pescando y hasta azotando pequeños animales contra el piso. También come insectos y frutas.",
      curiosities:
        'En otros países tiene nombres como Bienteveo, Bichofue, Pitogüé y Cristofué: todos hacen referencia a su canto. En Uruguay también lo llaman "Bicho Feo" por este mismo motivo.',
    },
    gallery: [
      {
        id: "cresta",
