...
export const columbiformes: Bird[] = [
  {
    ...
    description: {
      general:
        'Paloma de plumaje gris con manchas blancas en las alas y patas rojas. Se distribuye por Perú, Bolivia, Paraguay, Argentina, Brasil y Uruguay.".',
  ...
  },
  {
    ...
    description: {
      general:
        "Paloma nativa de Sudamérica, y la más común en Uruguay, donde es considerada plaga. Tiene marcas negras en el ala, lo cual la diferencia (además de por su mayor tamaño) de la Torcacita.",
      curiosities:
        "En Córdoba, Argentina, se cazan en grandes números debido a ser una plaga. Parte de su éxito reproductivo se debe a que puede anidar todo el año, mientras haya suficiente alimento.",
    },
  },
];
