import { Bird, BirdVariation } from "./birds/types";
...
export const uruguayBirds: Bird[] = [
  // Passeriformes - Passerines (Pájaros)
  {
    ...
    description: {
      general:
        "El Hornero es una de las aves más emblemáticas de Uruguay, conocida por construir nidos de barro en forma de horno. Su plumaje es principalmente rufo (rojizo-marrón) con partes inferiores más claras. Es un ave territorial y muy vocal, especialmente durante la época reproductiva.",
      curiosities:
        "El nido de los horneros dura aproximadamente un año y llega a ser utilizado por otras especies.",
    },
  },
  {
    id: "ratonera",
  ...
  },
  {
    ...
    description: {
      general:
        "La Calandria es un ave muy común en Uruguay, conocida por su habilidad para imitar el canto de otras aves. Su plumaje es principalmente gris y blanco, con un pico y negro.",
  ...
  },
  {
    ...
    description: {
      general:
        "El Pato Barcino es una ave acuática común en Uruguay, conocida por su plumaje verde y blanco.",
